...
export default function PledgeFulfilled({
  userName,
  partnerName,
  partnerType,
  items,
  ...
  return (
    <Html>
      <Preview>Your {partnerType} has been confirmed!</Preview>
      <Body
        style={{
      ...
      >
        ...
        >
          ...
          >
            ...
            confirmed receiving your items. Thank you for your{' '}
            {partnerType === 'donate'
              ? 'donation'
              : partnerType === 'sell'
                ? 'contribution'
          ...
          >
            ...
            >
              Every item counts. You&apos;re helping build a more sustainable
              fashion future.
            </Text>
          </Section>
